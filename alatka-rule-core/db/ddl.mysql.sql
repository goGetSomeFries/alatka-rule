...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则组表';
...
(
    ...
    `G_KEY`   varchar(50)  NOT NULL COMMENT 'ALK_RULE_GROUP_DEFINITION->G_KEY',
    PRIMARY KEY (`E_ID`),
    UNIQUE KEY `ALK_RULE_EXTENDED_DEFINITION_UNIQUE` (`R_ID`, `E_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则扩展属性表';
...
(
    ...
    `G_KEY`        varchar(50)    NOT NULL COMMENT 'ALK_RULE_GROUP_DEFINITION->G_KEY',
    PRIMARY KEY (`U_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则单元表';
...
-- alatka.ALK_RULE_DATASOURCE_EXT_DEFINITION definition
...
(
    ...
    `G_KEY`   varchar(50)  NOT NULL COMMENT 'ALK_RULE_GROUP_DEFINITION->G_KEY',
    PRIMARY KEY (`S_ID`),
    UNIQUE KEY `ALK_RULE_EXTENDED_DEFINITION_UNIQUE` (`D_ID`, `S_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则外部数据源扩展属性表';
