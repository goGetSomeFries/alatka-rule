...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则组表';
...
(
    ...
    PRIMARY KEY (`R_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则表';
...
(
    ...
    `G_KEY`   varchar(50)  NOT NULL COMMENT 'ALK_RULE_GROUP_DEFINITION->G_KEY',
    PRIMARY KEY (`E_ID`),
    UNIQUE KEY `ALK_RULE_EXTENDED_DEFINITION_UNIQUE` (`G_KEY`, `E_KEY`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则扩展属性表';
...
(
    ...
    `G_KEY`        varchar(50)    NOT NULL COMMENT 'ALK_RULE_GROUP_DEFINITION->G_KEY',
    PRIMARY KEY (`U_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则单元表';
...
(
    ...
    PRIMARY KEY (`D_ID`),
    UNIQUE KEY `ALK_RULE_DATASOURCE_DEFINITION_UNIQUE` (`D_KEY`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则外部数据源表';
...
(
    ...
    `G_KEY`        varchar(50) NOT NULL COMMENT 'ALK_RULE_GROUP_DEFINITION->G_KEY',
    PRIMARY KEY (`P_ID`),
    UNIQUE KEY `ALK_RULE_PARAM_DEFINITION_UNIQUE` (`G_KEY`, `P_KEY`)
